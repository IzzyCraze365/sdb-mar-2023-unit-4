...
// ! Inlcudes not going to work on an array of objects
// let nature = placeholderQuestions[0].category.includes("Nature");
// console.log(nature);
// ! You can do an includes on a string
// let myString = "cat";
...
let computer =
  ...
  populateCategory("history-title", ".history", history);
